...
public class HostController {
	...
	public String hostMain(Model model, @SessionAttribute(value = "loginHost", required = false) Host loginHost,
		...
		for (Reservation reservation : reservations) {
			...
			BoardDTO boardDTOre = new BoardDTO();
			boardDTOre.setBoard(board);
			boardDTOre.setCar(car);
			
			rDTO.setBoardDTO(boardDTOre);
...
//		log.info("str: {}", str);
	...
	public String hostReservation(Model model, @SessionAttribute(value = "loginHost", required = false) Host loginHost,
	...
	// 호스트 예약 확정
	@PostMapping("confirm")
	public String hostReservationConfirm(@SessionAttribute(value = "loginHost", required = false) Host loginHost,
			@RequestParam Long reservation_id) {
	...
	// 호스트 예약 거절
	@PostMapping("reject")
	public String hostReservationReject(@SessionAttribute(value = "loginHost", required = false) Host loginHost,
			@RequestParam Long reservation_id) {
